 ...
 * baseado em array.
 */
public abstract class StaticList<E> implements List<E> {
	private E[] elements;
	...
	public int contaElementos(E el) throws IllegalArgumentException {
		if (el == null) {
			...
			return contaElementos(el, numElements - 1);
		}
	}
	
	private int contaElementos(E element, int pos) {
		if (pos < 0) {
			return 0;
		}
	
		return (element.equals(elements[pos]) ? (1 + contaElementos(element, pos - 1)) : contaElementos(element, pos - 1));
	}
